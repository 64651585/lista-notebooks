...
class NotebooksTest < ApplicationSystemTestCase
  ...
  test "should create notebook" do
    ...
    fill_in "Armanezamento", with: @notebook.armanezamento
    fill_in "Descricao", with: @notebook.descricao
    fill_in "Marca", with: @notebook.marca
    fill_in "Memoria", with: @notebook.memoria
    fill_in "Preco", with: @notebook.preco
    fill_in "Processador", with: @notebook.processador
    fill_in "Sistema operacional", with: @notebook.sistema_operacional
